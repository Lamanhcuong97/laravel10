...
@section('content')
	<!-- CONTENT section -->
		<div id="pageContent">			
			<!-- parallax-img -->
			<section class="content--parallax content--parallax-sm offset-top-0" data-image="https://images.pexels.com/photos/322207/pexels-photo-322207.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
	...
	Ut enim ad minim veniam, quis nostrud exercitation ullamco.</em>
		...
		non proident, sunt in culpa qui officia deserunt mollit anim id est laborum
			...
			<!-- / -->
			<!-- parallax-img -->
			<section class="content--parallax content--parallax-sm offset-top-0" data-image="https://images.pexels.com/photos/373934/pexels-photo-373934.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
				<div class="content">
					<div class="container">
						<div class="parallax-text">
							<div class="block-table">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-3 col-sm-6 col-xs-6">
							<a class="link-img-hover1" href="#"><img src="https://scontent.fhan2-1.fna.fbcdn.net/v/t1.0-9/36242377_2067400190165436_8684630808331288576_n.jpg?_nc_cat=0&oh=b67efd3a6e17eb7f6222e8e22ce6d579&oe=5BCFE839" class="img-responsive-block" alt=""></a>							
							<div class="divider divider--md1"></div>
							<p>
								...
								<div class="slider-blog__item">
									<div class="row">
										<div class="col-xs-12 col-sm-2 col-sm-offset-3 box-foto">
											<img src="https://scontent.fhan2-1.fna.fbcdn.net/v/t1.0-9/12289498_1640339722871487_563855908850459080_n.jpg?_nc_cat=0&oh=604b9bf500c74d8f939558facaaea06e&oe=5C054F0E" alt="">
										</div>
